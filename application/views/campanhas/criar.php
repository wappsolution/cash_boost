<div class="container mx-auto p-4">
    <h1 class="text-2xl font-bold mb-4">Criar Nova Campanha</h1>
    ...
    <?php echo form_open('campanhas/store'); ?>
        <div class="mb-4">
        ...
        <div class="mb-4">
            ...
            <textarea name="descricao" id="descricao" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"><?php echo set_value('descricao'); ?></textarea>
        </div>

        <div class="mb-4">
            <label for="data_inicio" class="block text-gray-700 text-sm font-bold mb-2">Data de Início:</label>
            <input type="date" name="data_inicio" id="data_inicio" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value="<?php echo set_value('data_inicio'); ?>">
        </div>

        <div class="mb-4">
            <label for="data_fim" class="block text-gray-700 text-sm font-bold mb-2">Data de Fim:</label>
            <input type="date" name="data_fim" id="data_fim" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value="<?php echo set_value('data_fim'); ?>">
        </div>
        ...
        <div class="mb-4">
            ...
            <select name="recorrencia" id="recorrencia" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                <option value="diaria" <?php echo set_select('recorrencia', 'diaria'); ?>>Diária</option>
                <option value="semanal" <?php echo set_select('recorrencia', 'semanal'); ?>>Semanal</option>
                <option value="mensal" <?php echo set_select('recorrencia', 'mensal'); ?>>Mensal</option>
                <option value="unica" <?php echo set_select('recorrencia', 'unica'); ?>>Única</option>
            </select>
        </div>
